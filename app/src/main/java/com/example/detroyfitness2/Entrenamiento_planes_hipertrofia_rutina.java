...
public class Entrenamiento_planes_hipertrofia_rutina extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.entrenamiento_planes_hipertrofia_rutina);
        ...
        botontoolbar_perfil.setOnClickListener(new View.OnClickListener() { //ejecucion del botón de perfil
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Entrenamiento_planes_hipertrofia_rutina.this, Perfil.class);
        ...
        botontoolbar_nutricion.setOnClickListener(new View.OnClickListener() { //ejecucion del botón de nutricion
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Entrenamiento_planes_hipertrofia_rutina.this, Nutricion.class);
                startActivity(intent);
            }
        });
        ...
        botontoolbar_entrenamiento.setOnClickListener(new View.OnClickListener() { //ejecucion del botón de entrenamiento
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Entrenamiento_planes_hipertrofia_rutina.this, Entrenamiento_planes_hipertrofia_rutina.class);
                startActivity(intent);
            }
    });
        ...
        boton_atras.setOnClickListener(new View.OnClickListener() { //ejecucion del botón de atras
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Entrenamiento_planes_hipertrofia_rutina.this, Entrenamiento_planes_hipertrofia.class);
                startActivity(intent);
            }
        });
//==================================================================================================
