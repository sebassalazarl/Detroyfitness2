...
public final class EntrenamientoPlanesPerdidaRutinaBinding implements ViewBinding {
  @NonNull
  ...
  private EntrenamientoPlanesPerdidaRutinaBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static EntrenamientoPlanesPerdidaRutinaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static EntrenamientoPlanesPerdidaRutinaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.entrenamiento_planes_perdida_rutina, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EntrenamientoPlanesPerdidaRutinaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new EntrenamientoPlanesPerdidaRutinaBinding((ConstraintLayout) rootView,
