...
public final class EntrenamientoPlanesHipertrofiaRutinaBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final TextView textoHipertrofia;
  ...
  private EntrenamientoPlanesHipertrofiaRutinaBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull TextView textView3, @NonNull TextView textoHipertrofia,
    ...
    this.textoHipertrofia = textoHipertrofia;
  ...
  @NonNull
  public static EntrenamientoPlanesHipertrofiaRutinaBinding inflate(
  ...
  public static EntrenamientoPlanesHipertrofiaRutinaBinding inflate(
    ...
    View root = inflater.inflate(R.layout.entrenamiento_planes_hipertrofia_rutina, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EntrenamientoPlanesHipertrofiaRutinaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.texto_hipertrofia;
      TextView textoHipertrofia = ViewBindings.findChildViewById(rootView, id);
      if (textoHipertrofia == null) {
        break missingId;
      }
      ...
      return new EntrenamientoPlanesHipertrofiaRutinaBinding((ConstraintLayout) rootView,
          ...
          textoHipertrofia, textonutricion, toolbar);
    }
