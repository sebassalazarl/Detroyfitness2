...
public final class EntrenamientoMostrarRutinaBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RecyclerView containerEjercicios;
  ...
  private EntrenamientoMostrarRutinaBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull RecyclerView containerEjercicios, @NonNull RelativeLayout header,
      @NonNull RelativeLayout main, @NonNull TextView textView, @NonNull TextView textView2,
      @NonNull TextView textView3, @NonNull RelativeLayout toolbar) {
    ...
    this.containerEjercicios = containerEjercicios;
    this.header = header;
    this.main = main;
  ...
  @NonNull
  public static EntrenamientoMostrarRutinaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static EntrenamientoMostrarRutinaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.entrenamiento_mostrar_rutina, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EntrenamientoMostrarRutinaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.container_ejercicios;
      RecyclerView containerEjercicios = ViewBindings.findChildViewById(rootView, id);
      if (containerEjercicios == null) {
        break missingId;
      }
      ...
      return new EntrenamientoMostrarRutinaBinding((ConstraintLayout) rootView, BEntrenamiento,
          BFlechaAtrasEntrenamiento, BNutricion, BPerfil, botonEntrenoImg, botonnutricionImg,
          botonperfilImg, containerEjercicios, header, main, textView, textView2, textView3,
          toolbar);
    }
