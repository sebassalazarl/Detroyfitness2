...
public final class RecetasBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton BReceta1;

  @NonNull
  public final ImageButton BReceta2;
  ...
  @NonNull
  public final ImageButton flechaAtrasRecetas;
  ...
  private RecetasBinding(@NonNull ConstraintLayout rootView, @NonNull Button BEntrenamiento,
      @NonNull Button BNutricion, @NonNull Button BPerfil, @NonNull ImageButton BReceta1,
      @NonNull ImageButton BReceta2, @NonNull ImageView botonEntrenoImg,
      @NonNull ImageView botonnutricionImg, @NonNull ImageView botonperfilImg,
      @NonNull ImageButton flechaAtrasRecetas, @NonNull RelativeLayout header,
      @NonNull RelativeLayout main, @NonNull Button referencia, @NonNull TextView textView,
      @NonNull TextView textView2, @NonNull TextView textView3, @NonNull TextView textonutricion,
      @NonNull RelativeLayout toolbar) {
    this.rootView = rootView;
    this.BEntrenamiento = BEntrenamiento;
    this.BNutricion = BNutricion;
    this.BPerfil = BPerfil;
    this.BReceta1 = BReceta1;
    this.BReceta2 = BReceta2;
    this.botonEntrenoImg = botonEntrenoImg;
    this.botonnutricionImg = botonnutricionImg;
    this.botonperfilImg = botonperfilImg;
    this.flechaAtrasRecetas = flechaAtrasRecetas;
    this.header = header;
    this.main = main;
  ...
  @NonNull
  public static RecetasBinding inflate(@NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static RecetasBinding inflate(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent,
      boolean attachToParent) {
    View root = inflater.inflate(R.layout.recetas, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RecetasBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.B_receta1;
      ImageButton BReceta1 = ViewBindings.findChildViewById(rootView, id);
      if (BReceta1 == null) {
        break missingId;
      }

      id = R.id.B_receta2;
      ImageButton BReceta2 = ViewBindings.findChildViewById(rootView, id);
      if (BReceta2 == null) {
        break missingId;
      }
      ...
      id = R.id.flecha_atras_recetas;
      ImageButton flechaAtrasRecetas = ViewBindings.findChildViewById(rootView, id);
      if (flechaAtrasRecetas == null) {
        break missingId;
      }
      ...
      return new RecetasBinding((ConstraintLayout) rootView, BEntrenamiento, BNutricion, BPerfil,
          BReceta1, BReceta2, botonEntrenoImg, botonnutricionImg, botonperfilImg,
          flechaAtrasRecetas, header, main, referencia, textView, textView2, textView3,
