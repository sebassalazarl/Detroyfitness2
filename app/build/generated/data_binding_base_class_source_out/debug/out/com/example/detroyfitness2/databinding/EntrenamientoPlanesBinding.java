...
public final class EntrenamientoPlanesBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageButton BRutinaFuncional;

  @NonNull
  public final ImageButton BRutinaHipertrofia;

  @NonNull
  public final ImageButton BRutinaIniciacion;

  @NonNull
  public final ImageButton BRutinaPerdida;
  ...
  private EntrenamientoPlanesBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button BEntrenamiento, @NonNull ImageButton BFlechaAtrasEntrenamiento,
      @NonNull Button BNutricion, @NonNull Button BPerfil, @NonNull ImageButton BRutinaFuncional,
      @NonNull ImageButton BRutinaHipertrofia, @NonNull ImageButton BRutinaIniciacion,
      @NonNull ImageButton BRutinaPerdida, @NonNull ImageView botonEntrenoImg,
      @NonNull ImageView botonnutricionImg, @NonNull ImageView botonperfilImg,
      @NonNull RelativeLayout header, @NonNull RelativeLayout main, @NonNull Button referencia,
    ...
    this.BRutinaFuncional = BRutinaFuncional;
    this.BRutinaHipertrofia = BRutinaHipertrofia;
    this.BRutinaIniciacion = BRutinaIniciacion;
    this.BRutinaPerdida = BRutinaPerdida;
  ...
  @NonNull
  public static EntrenamientoPlanesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static EntrenamientoPlanesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.entrenamiento_planes, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EntrenamientoPlanesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.B_rutinaFuncional;
      ImageButton BRutinaFuncional = ViewBindings.findChildViewById(rootView, id);
      if (BRutinaFuncional == null) {
        break missingId;
      }

      id = R.id.B_rutinaHipertrofia;
      ImageButton BRutinaHipertrofia = ViewBindings.findChildViewById(rootView, id);
      if (BRutinaHipertrofia == null) {
        break missingId;
      }

      id = R.id.B_rutinaIniciacion;
      ImageButton BRutinaIniciacion = ViewBindings.findChildViewById(rootView, id);
      if (BRutinaIniciacion == null) {
        break missingId;
      }

      id = R.id.B_rutinaPerdida;
      ImageButton BRutinaPerdida = ViewBindings.findChildViewById(rootView, id);
      if (BRutinaPerdida == null) {
        break missingId;
      }
      ...
      return new EntrenamientoPlanesBinding((ConstraintLayout) rootView, BEntrenamiento,
          BFlechaAtrasEntrenamiento, BNutricion, BPerfil, BRutinaFuncional, BRutinaHipertrofia,
          BRutinaIniciacion, BRutinaPerdida, botonEntrenoImg, botonnutricionImg, botonperfilImg,
          header, main, referencia, textView, textView2, textView3, textonutricion, toolbar);
    }
