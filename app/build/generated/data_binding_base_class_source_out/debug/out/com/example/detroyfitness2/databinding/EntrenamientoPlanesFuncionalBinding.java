...
public final class EntrenamientoPlanesFuncionalBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final Button BRutinaFuncionalDia1;

  @NonNull
  public final Button BRutinaFuncionalDia2;

  @NonNull
  public final Button BRutinaFuncionalDia3;

  @NonNull
  public final Button BRutinaFuncionalDia4;

  @NonNull
  public final Button BRutinaFuncionalDia5;
  ...
  private EntrenamientoPlanesFuncionalBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button BEntrenamiento, @NonNull ImageButton BFlechaAtrasEntrenamiento,
      @NonNull Button BNutricion, @NonNull Button BPerfil, @NonNull Button BRutinaFuncionalDia1,
      @NonNull Button BRutinaFuncionalDia2, @NonNull Button BRutinaFuncionalDia3,
      @NonNull Button BRutinaFuncionalDia4, @NonNull Button BRutinaFuncionalDia5,
    ...
    this.BRutinaFuncionalDia1 = BRutinaFuncionalDia1;
    this.BRutinaFuncionalDia2 = BRutinaFuncionalDia2;
    this.BRutinaFuncionalDia3 = BRutinaFuncionalDia3;
    this.BRutinaFuncionalDia4 = BRutinaFuncionalDia4;
    this.BRutinaFuncionalDia5 = BRutinaFuncionalDia5;
  ...
  @NonNull
  public static EntrenamientoPlanesFuncionalBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static EntrenamientoPlanesFuncionalBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.entrenamiento_planes_funcional, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EntrenamientoPlanesFuncionalBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.B_rutinaFuncional_dia1;
      Button BRutinaFuncionalDia1 = ViewBindings.findChildViewById(rootView, id);
      if (BRutinaFuncionalDia1 == null) {
        break missingId;
      }

      id = R.id.B_rutinaFuncional_dia2;
      Button BRutinaFuncionalDia2 = ViewBindings.findChildViewById(rootView, id);
      if (BRutinaFuncionalDia2 == null) {
        break missingId;
      }

      id = R.id.B_rutinaFuncional_dia3;
      Button BRutinaFuncionalDia3 = ViewBindings.findChildViewById(rootView, id);
      if (BRutinaFuncionalDia3 == null) {
        break missingId;
      }

      id = R.id.B_rutinaFuncional_dia4;
      Button BRutinaFuncionalDia4 = ViewBindings.findChildViewById(rootView, id);
      if (BRutinaFuncionalDia4 == null) {
        break missingId;
      }

      id = R.id.B_rutinaFuncional_dia5;
      Button BRutinaFuncionalDia5 = ViewBindings.findChildViewById(rootView, id);
      if (BRutinaFuncionalDia5 == null) {
        break missingId;
      }
      ...
      return new EntrenamientoPlanesFuncionalBinding((ConstraintLayout) rootView, BEntrenamiento,
          BFlechaAtrasEntrenamiento, BNutricion, BPerfil, BRutinaFuncionalDia1,
          BRutinaFuncionalDia2, BRutinaFuncionalDia3, BRutinaFuncionalDia4, BRutinaFuncionalDia5,
          botonEntrenoImg, botonnutricionImg, botonperfilImg, header, textView, textView2,
          textView3, textoSobrecarga3, textonutricion, toolbar);
    }
