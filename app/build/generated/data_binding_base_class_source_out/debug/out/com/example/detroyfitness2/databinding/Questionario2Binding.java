...
public final class Questionario2Binding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final RadioGroup OBJETIVO;

  @NonNull
  public final RadioGroup RefNutr;
  ...
  @NonNull
  public final ImageButton flechaAtrasQuestionario2;
  ...
  @NonNull
  public final RadioButton p2R1;

  @NonNull
  public final RadioButton p2R2;

  @NonNull
  public final RadioButton p2R3;

  @NonNull
  public final RadioButton p2R4;
  ...
  private Questionario2Binding(@NonNull ConstraintLayout rootView, @NonNull Button BEntrenamiento,
      @NonNull Button BNutricion, @NonNull Button BPerfil, @NonNull Button BSiguiente,
      @NonNull TextView NombreUsuarioView, @NonNull RadioGroup OBJETIVO,
      @NonNull RadioGroup RefNutr, @NonNull ImageView botonEntrenoImg,
      @NonNull ImageView botonnutricionImg, @NonNull ImageView botonperfilImg,
      @NonNull ImageButton flechaAtrasQuestionario2, @NonNull ImageView fotoPerfil,
      @NonNull RelativeLayout header, @NonNull ImageView imageView, @NonNull ImageView imageView2,
      ...
      @NonNull RadioButton p1R3, @NonNull RadioButton p2R1, @NonNull RadioButton p2R2,
      @NonNull RadioButton p2R3, @NonNull RadioButton p2R4, @NonNull TextView textView,
      @NonNull TextView textView2, @NonNull TextView textView3, @NonNull TextView textView4,
      @NonNull TextView textView5, @NonNull RelativeLayout toolbar) {
  ...
  @NonNull
  public static Questionario2Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static Questionario2Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.questionario2, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static Questionario2Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.OBJETIVO;
      RadioGroup OBJETIVO = ViewBindings.findChildViewById(rootView, id);
      if (OBJETIVO == null) {
        break missingId;
      }

      id = R.id.Ref_Nutr;
      RadioGroup RefNutr = ViewBindings.findChildViewById(rootView, id);
      if (RefNutr == null) {
        break missingId;
      }
      ...
      id = R.id.flecha_atras_questionario2;
      ImageButton flechaAtrasQuestionario2 = ViewBindings.findChildViewById(rootView, id);
      if (flechaAtrasQuestionario2 == null) {
        break missingId;
      }
      ...
      id = R.id.p2_r1;
      RadioButton p2R1 = ViewBindings.findChildViewById(rootView, id);
      if (p2R1 == null) {
        break missingId;
      }

      id = R.id.p2_r2;
      RadioButton p2R2 = ViewBindings.findChildViewById(rootView, id);
      if (p2R2 == null) {
        break missingId;
      }

      id = R.id.p2_r3;
      RadioButton p2R3 = ViewBindings.findChildViewById(rootView, id);
      if (p2R3 == null) {
        break missingId;
      }

      id = R.id.p2_r4;
      RadioButton p2R4 = ViewBindings.findChildViewById(rootView, id);
      if (p2R4 == null) {
        break missingId;
      }
      ...
      return new Questionario2Binding((ConstraintLayout) rootView, BEntrenamiento, BNutricion,
          BPerfil, BSiguiente, NombreUsuarioView, OBJETIVO, RefNutr, botonEntrenoImg,
          botonnutricionImg, botonperfilImg, flechaAtrasQuestionario2, fotoPerfil, header,
          imageView, imageView2, imageView3, imageView6, imageView7, main, p1R1, p1R2, p1R3, p2R1,
          p2R2, p2R3, p2R4, textView, textView2, textView3, textView4, textView5, toolbar);
    }
