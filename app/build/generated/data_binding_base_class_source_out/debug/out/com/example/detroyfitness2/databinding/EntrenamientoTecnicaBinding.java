...
public final class EntrenamientoTecnicaBinding implements ViewBinding {
  @NonNull
  ...
  private EntrenamientoTecnicaBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull RelativeLayout header, @NonNull RelativeLayout main,
  ...
  @NonNull
  public static EntrenamientoTecnicaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static EntrenamientoTecnicaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.entrenamiento_tecnica, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static EntrenamientoTecnicaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new EntrenamientoTecnicaBinding((ConstraintLayout) rootView, BEntrenamiento,
          BNutricion, BPerfil, botonEntrenoImg, botonnutricionImg, botonperfilImg, flechaAtras,
          header, main, recyclerView, textView, textView2, textView3, textonutricion, toolbar);
    }
